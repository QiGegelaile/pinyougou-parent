...
app.controller('typeTemplateController' ,function($scope,$controller   ,typeTemplateService,brandService,specificationService){
    ...
    $scope.data = {data:[{id:1,text:"华为"},{id:2,text:"中兴"},{id:3,text:"美美"}]};

	$scope.brandList = {data:[{id:1,text:"华为"},{id:2,text:"中兴"},{id:3,text:"美美"}]};
    $scope.specificationList = {data:[{id:1,text:"华为"},{id:2,text:"中兴"},{id:3,text:"美美"}]};
